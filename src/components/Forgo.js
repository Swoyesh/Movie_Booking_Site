...
const Forgo = () => {
  ...
  return (
    <>
    <div className='container' style={{width: "35%", backgroundColor: "#081243", display: "flex", justifyContent: "center", boxShadow: "0px 0px 30px #fff", borderRadius: "6px", position: "relative", top: "10vh", overflow:"hidden", border: "1px solid white", alignItems: "stretch"}}>
            ...
            <div className='former'>
              <form>
                ...
                <div style={{position: "relative"}}>
                    <input type='image' src = {bg} className='cpt' height= "50vh" width="200vw"></input>
                    <div className='centered'><i>{ftext}</i></div>
                    <button onClick={generate} type = "button" style={{height: "0px", border: "none", backgroundColor: "#081243"}}><img src={rell} style={{height: "5vh", top: "0.5vh", position: "relative", left: "-185px" ,backgroundColor:"yellow", borderRadius: "5px", cursor: "pointer"}}></img></button>
                </div>
                <input type='text' style={{position: "relative", borderRadius: "5px", border: "none", padding: "7px", width: "90%", backgroundColor: "#fff", top: "3vh", marginLeft: "18px"}} className='iinp' placeholder="Enter Captcha Text" onChange={changer}></input>
                <div style={{width: "80%"}}>
